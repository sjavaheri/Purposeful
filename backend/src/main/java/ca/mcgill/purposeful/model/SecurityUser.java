...
/** 
 * Secure User class that Spring can read, which wraps the AppUser class
 * Makes AppUser compatible with Spring Security
 */
public class SecurityUser implements UserDetails{
    ...
    /**
     * Method that converts the authorities of the AppUser into an arraylist of SimpleGrantedAuthoritys
     * SimpleGrantedAuthorities is an class that Implements the GrantedAuthority interface
