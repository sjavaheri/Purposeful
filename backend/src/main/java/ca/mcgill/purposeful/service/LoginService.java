...
/**
 * Service to allow a user to login to the application
...
public class LoginService {
     ...
     * @param authentication - the authentication object for the user, retrieved by the LoginController
    ...
    public String generateToken(Authentication authentication) {
        ...
        JwtClaimsSet claims = JwtClaimsSet.builder()
                ...
                .claim("grantedAuthorities", grantedAuthorities) // adding a record in the json object for the authorities the user has 
                .build();
