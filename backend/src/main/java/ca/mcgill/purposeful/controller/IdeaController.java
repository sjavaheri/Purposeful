...
public class IdeaController {
  ...
  public ResponseEntity<List<IdeaDTO>> filterIdeas(
    ...
    public IdeaDTO modifyIdea(
        ...
        Idea modifiedIdea = ideaService.modifyIdea(id, title, date, descriptions, purpose, isPaid, inProgress, isPrivate, domainIds, techIds, topicIds, imgUrlIds, iconUrlId);
