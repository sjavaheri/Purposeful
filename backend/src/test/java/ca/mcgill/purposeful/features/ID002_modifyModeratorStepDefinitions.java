...
public class ID002_modifyModeratorStepDefinitions {
    ...
    public void moderatorAccountIsUpdatedWithNewLastNameFirstName(String email, String new_lastname, String new_firstname) {
        ...
        this.response = client.exchange("/api/appuser/moderator", HttpMethod.PUT, requestEntity,
                AppUserDto.class);
    }
    ...
    public void moderatorAccountIsUpdatedWithNewPassword(String email, String new_password) {
        ...
        HttpEntity<AppUserDto> requestEntity = new HttpEntity<>(appUserDto,
                cucumberUtil.bearerAuthHeader(this.jwtToken));
        this.response = client.exchange("/api/appuser/moderator/password", HttpMethod.PUT, requestEntity,
                AppUserDto.class);
    }
    ...
    public void moderatorAccountIsErroneouslyUpdatedWithNewLastNameFirstName(String email, String new_lastname, String new_firstname) {
        // create a DTO to send the request to the service
        AppUserDto appUserDto = new AppUserDto(email, "", new_firstname, new_lastname);
    ...
    public void moderatorAccountIsErroneouslyUpdatedWithNewPassword(String email, String new_password) {
        // create a DTO to send the request to the service
        AppUserDto appUserDto = new AppUserDto(email, new_password, "", "");
    ...
    public void moderatorAccountWithEmailHaveAsPassword(
