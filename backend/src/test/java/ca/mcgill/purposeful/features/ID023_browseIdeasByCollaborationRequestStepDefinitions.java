...
public class ID023_browseIdeasByCollaborationRequestStepDefinitions {
    ...
    public void iAmloggedAsTheUserWithEmailAndPassword (String email, String password) {
        ...
        // In this case we are testing whether the browse ideas by collaboration request response is correct , thus we only
        // need the token
    ...
    public void theUserRequestsToBrowseIdeasByCollaborationRequest () {
        ...
        if(this.authHeader != null){
            this.response =
                    client.exchange("/api/idea/user/requests", HttpMethod.GET, requestEntity, ArrayList.class);
