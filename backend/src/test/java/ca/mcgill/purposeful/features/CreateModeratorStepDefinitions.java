...
public class CreateModeratorStepDefinitions {
    ...
    public void a_new_moderator_account_is_created_with_something_something_something_and_something(String firstname,
            String lastname, String email, String password, String strArg1, String strArg2, String strArg3,
    ...
    public void a_new_moderator_account_exists_in_the_database_with_something_something_something_and_something(
            String firstname, String lastname, String email, String password, String strArg1, String strArg2,
    ...
    public void the_number_of_moderator_accounts_in_the_database_is_something(String strArg1) throws Throwable {
        throw new PendingException();
    }
