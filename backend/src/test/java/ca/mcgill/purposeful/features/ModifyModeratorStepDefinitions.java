...
public class ModifyModeratorStepDefinitions {
  ...
  public void that_the_user_is_logged_with_the_email_something_and_the_password_something(
      String strArg1,
  ...
  public void the_user_requests_to_update_their_account_information_with_the_following_details()
      throws Throwable {
    throw new PendingException();
  }

  @When("^the user request to update their account using the old password (.+) with new password (.+)$")
  public void the_user_request_to_update_their_account_using_the_old_password_with_new_password(
      String oldpassword,
  ...
  public void account_with_email_something_should_be_updated_with_the_following_details(
      String strArg1)
      throws Throwable {
    throw new PendingException();
  }
  ...
  public void the_number_of_moderator_accounts_in_the_datavase_shall_be_something(String strArg1)
      throws Throwable {
    throw new PendingException();
  }
  ...
  public void the_number_of_moderator_accounts_in_the_database_is_still_something(String strArg1)
      throws Throwable {
    throw new PendingException();
  }
