Feature: Create Idea
  ...
  Scenario Outline: Unsuccessfully create an idea
    ...
    Examples: 
      ...
      | Smart Schedule Manager                                                                                  | Save people time | AI daily schedule builder | true   | false      | false     | Software,Science     | AI,Machine Learning | Tensorflow,Python |              | img.png,img2.png    | Necessary fields have been left empty                                 |
      ...
      | Smart Schedule Manager                                                                                  | Save people time | AI daily schedule builder | true   | false      | false     | Software,Science			| AI,Machine Learning | Tensorflow,Python | schedule4.png | img.png,img2.png   | You are attempting to link your idea to an object that does not exist |
