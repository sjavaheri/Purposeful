Feature: Browse ideas by domain by Domain, Topic, or Tech
  ...
  Background:
    ...
    And the database contains the following ideas (Strategy1):
      ...
      | id | title             | domains | topics | techs    | date | description | iconUrl  | purpose    | author | private |
      | 15 | Website Idea      | 2       | 5      | 10,11,12 | 1500 | Cool idea   | test.com | Great idea | 1      | False   |
      | 16 | Video Game        | 2       | 6      | 13       | 1400 | Cool idea   | test.com | Great idea | 1      | False   |
      | 17 | Microcontroller   | 2,4     | 7      | 10,13    | 1300 | Cool idea   | test.com | Great idea | 1      | False   |
      | 18 | Command-Line tool | 2       | 8      | 10       | 1200 | Cool idea   | test.com | Great idea | 1      | False   |
      | 19 | Novel             | 3       | 9      | 14       | 1100 | Cool idea   | test.com | Great idea | 1      | False   |
      | 20 | Circuit           | 4       | 9      | 14       | 1000 | Cool idea   | test.com | Great idea | 1      | True    |
  ...
  Scenario Outline: Successfully browse ideas by domain, topic, and tech
    ...
    Examples:
      ...
      | 3,4        | null      | null      | 17,19          |
      | 2,4        | null      | null      | 15,16,17,18    |
      | 2,3,4      | null      | null      | 15,16,17,18,19 |
      | 2          | 5         | null      | 15             |
      | 4          | null      | 10        | 17             |
