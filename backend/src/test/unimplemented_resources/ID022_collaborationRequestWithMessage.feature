Feature: Send a collaboration request
    ...
    Scenario Outline: Unsuccessfully send collaboration request
        ...
        Examples:
            ...
            | jane.doe@gmail.com       | P@ssWord1234 | 17      | "Hi, please let me join your project" | null              | 2                     | 3                     | Cannot send another collaboration request to the same person before they respond to the previous request |
            | jane.doe@gmail.com       | P@ssWord1234 | 18      | "Hi, please let me join your project" | null              | 2                     | 3                     | Cannot send another collaboration request to the same person before they respond to the previous request |
            | wassim.jabbour@gmail.com | P@ssWord1234 | 20      | "Hi, please let me join your project" | "428-8794-4237"   | 1                     | 1                     | Cannot send another collaboration request to the same person before they respond to the previous request |
            | jane.doe@gmail.com       | P@ssWord1234 | 21      | "Hi, please let me join your project" | "428-8794-4238"   | 1                     | 3                     | Cannot send another collaboration request to the same person before they respond to the previous request |
